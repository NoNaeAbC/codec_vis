...
CODEC_PKGS := x265 libjpeg libraw libvvenc libvvdec uvg266 SvtAv1Enc libva libva-drm avm libde265 dav1d charls libpng16 libjxl libjxl_threads libopenjp2 x264 openh264 libvmaf
...
CODEC_LIBS := $(call pkg_libs,$(CODEC_PKGS)) $(JXRLIB_LIBS) -ldl -lpthread
...
PREVIEW_DECODER_SRCS := gui/preview_decoders.cpp

.PHONY: all test clean test_gui_model test_draw_list test_ui_interaction test_ui_widgets test_wayland_window test_platform_portal test_text_shaper test_text_atlas test_encoder_backends test_app_commands test_encode_runner test_metrics test_image_ops test_raw_image_conversion test_settings test_storage
...
test: test_gui_model test_draw_list test_ui_interaction test_ui_widgets test_wayland_window test_platform_portal test_text_shaper test_text_atlas test_encoder_backends test_app_commands test_encode_runner test_metrics test_image_ops test_raw_image_conversion test_settings test_storage
...
build/xdg-shell-protocol.o: build/xdg-shell-protocol.c build/xdg-shell-client-protocol.h | build
	$(CC) $(CPPFLAGS) $(CFLAGS) $(GUI_CFLAGS) -Ibuild -c -o $@ build/xdg-shell-protocol.c
...
build/test_draw_list: gui/test_draw_list.cpp gui/draw_list.cpp gui/ui_widgets.cpp gui/text_atlas.cpp gui/text_shaper.cpp gui/metrics.cpp $(MODEL_SRCS) codec_gui_x265.hpp | build
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $(CODEC_CFLAGS) $(GUI_CFLAGS) -o $@ gui/test_draw_list.cpp gui/draw_list.cpp gui/ui_widgets.cpp gui/text_atlas.cpp gui/text_shaper.cpp gui/metrics.cpp $(MODEL_SRCS) $(CODEC_LIBS) $(GUI_LIBS) $(LDFLAGS)

test_ui_interaction: build/test_ui_interaction
	./build/test_ui_interaction

build/test_ui_interaction: gui/test_ui_interaction.cpp gui/ui_interaction.cpp gui/metrics.cpp $(MODEL_SRCS) codec_gui_x265.hpp | build
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $(CODEC_CFLAGS) -o $@ gui/test_ui_interaction.cpp gui/ui_interaction.cpp gui/metrics.cpp $(MODEL_SRCS) $(CODEC_LIBS) $(LDFLAGS)

test_ui_widgets: build/test_ui_widgets
	./build/test_ui_widgets

build/test_ui_widgets: gui/test_ui_widgets.cpp gui/ui_widgets.cpp gui/image_list_model.hpp gui/metrics.cpp $(MODEL_SRCS) codec_gui_x265.hpp | build
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $(CODEC_CFLAGS) -o $@ gui/test_ui_widgets.cpp gui/ui_widgets.cpp gui/metrics.cpp $(MODEL_SRCS) $(CODEC_LIBS) $(LDFLAGS)

test_wayland_window: build/test_wayland_window
	./build/test_wayland_window

build/test_wayland_window: gui/test_wayland_window.cpp gui/wayland_window.cpp gui/wayland_window.hpp build/xdg-shell-protocol.o | build
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $(CODEC_CFLAGS) $(GUI_CFLAGS) -Ibuild -o $@ gui/test_wayland_window.cpp gui/wayland_window.cpp build/xdg-shell-protocol.o $(CODEC_LIBS) $(GUI_LIBS) $(LDFLAGS)
...
build/test_encoder_backends: gui/test_encoder_backends.cpp gui/encoder_backends.cpp $(PREVIEW_DECODER_SRCS) $(CODEC_BACKEND_SRCS) codec_gui_x265.hpp | build
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $(CODEC_CFLAGS) -o $@ gui/test_encoder_backends.cpp gui/encoder_backends.cpp $(PREVIEW_DECODER_SRCS) $(CODEC_BACKEND_SRCS) $(CODEC_LIBS) $(LDFLAGS)

test_app_commands: build/test_app_commands
	./build/test_app_commands

build/test_app_commands: gui/test_app_commands.cpp gui/app_commands.cpp gui/platform_portal.cpp gui/metrics.cpp gui/image_ops.cpp gui/encoder_backends.cpp $(PREVIEW_DECODER_SRCS) codec_gui_image_io.cpp $(MODEL_SRCS) $(CODEC_BACKEND_SRCS) codec_gui_x265.hpp | build
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $(CODEC_CFLAGS) $(GUI_CFLAGS) -o $@ gui/test_app_commands.cpp gui/app_commands.cpp gui/platform_portal.cpp gui/metrics.cpp gui/image_ops.cpp gui/encoder_backends.cpp $(PREVIEW_DECODER_SRCS) codec_gui_image_io.cpp $(MODEL_SRCS) $(CODEC_BACKEND_SRCS) $(CODEC_LIBS) $(GUI_LIBS) $(LDFLAGS)

test_encode_runner: build/test_encode_runner
	./build/test_encode_runner

build/test_encode_runner: gui/test_encode_runner.cpp gui/encode_runner.cpp gui/encoder_backends.cpp $(PREVIEW_DECODER_SRCS) gui/metrics.cpp $(MODEL_SRCS) $(CODEC_BACKEND_SRCS) codec_gui_x265.hpp | build
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $(CODEC_CFLAGS) -o $@ gui/test_encode_runner.cpp gui/encode_runner.cpp gui/encoder_backends.cpp $(PREVIEW_DECODER_SRCS) gui/metrics.cpp $(MODEL_SRCS) $(CODEC_BACKEND_SRCS) $(CODEC_LIBS) $(LDFLAGS)

test_metrics: build/test_metrics
	./build/test_metrics

build/test_metrics: gui/test_metrics.cpp gui/metrics.cpp gui/metrics.hpp codec_gui_x265.hpp | build
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $(CODEC_CFLAGS) -o $@ gui/test_metrics.cpp gui/metrics.cpp $(CODEC_LIBS) $(LDFLAGS)
...
build/gui_app_state.o: gui/app_update.cpp gui/app_state.hpp gui/viewer_model.hpp | build
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $(CODEC_CFLAGS) -c -o $@ gui/app_update.cpp
...
build/gui_app_commands.o: gui/app_commands.cpp gui/app_commands.hpp gui/app_state.hpp gui/encoder_backends.hpp gui/metrics.hpp gui/platform_portal.hpp codec_gui_image_io.hpp | build
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $(CODEC_CFLAGS) $(GUI_CFLAGS) -c -o $@ gui/app_commands.cpp

build/gui_platform_portal.o: gui/platform_portal.cpp gui/platform_portal.hpp gui/app_state.hpp | build
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $(GUI_CFLAGS) $(CODEC_CFLAGS) -c -o $@ gui/platform_portal.cpp
...
build/gui_ui_widgets.o: gui/ui_widgets.cpp gui/ui_widgets.hpp gui/app_state.hpp gui/layout.hpp gui/viewer_model.hpp gui/image_list_model.hpp | build
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $(CODEC_CFLAGS) -c -o $@ gui/ui_widgets.cpp

build/gui_wayland_window.o: gui/wayland_window.cpp gui/wayland_window.hpp build/xdg-shell-client-protocol.h | build
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $(GUI_CFLAGS) -Ibuild -c -o $@ gui/wayland_window.cpp
...
build/gui_render_vulkan.o: gui/render_vulkan.cpp gui/render_vulkan.hpp gui/raw_image_conversion.hpp gui/wayland_window.hpp gui/draw_list.hpp gui/text_atlas.hpp | build
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $(GUI_CFLAGS) -Ibuild -c -o $@ gui/render_vulkan.cpp
...
build/gui_encoder_backends.o: gui/encoder_backends.cpp gui/encoder_backends.hpp gui/preview_decoders.hpp gui/app_state.hpp codec_gui_x265.hpp | build
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $(CODEC_CFLAGS) -c -o $@ gui/encoder_backends.cpp
...
build/gui_preview_decoders.o: gui/preview_decoders.cpp gui/preview_decoders.hpp gui/encoder_backends.hpp gui/app_state.hpp codec_gui_x265.hpp | build
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $(CODEC_CFLAGS) -c -o $@ gui/preview_decoders.cpp
...
build/gui_main.o: gui/main_gui.cpp gui/app_state.hpp gui/app_commands.hpp gui/draw_list.hpp gui/layout.hpp gui/render_vulkan.hpp gui/text_atlas.hpp gui/text_shaper.hpp gui/ui_interaction.hpp gui/wayland_window.hpp gui/viewer_model.hpp codec_gui_image_io.hpp gui/encoder_backends.hpp gui/encode_runner.hpp | build
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $(CODEC_CFLAGS) $(GUI_CFLAGS) -Ibuild -c -o $@ gui/main_gui.cpp
